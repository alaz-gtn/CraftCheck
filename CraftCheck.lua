...
if isES then
    L = {
        ...
        HINT           = "Click en una fila para expandir. Shift+click en un objeto para enlazarlo en el chat.",
    ...
    L = {
        ...
        HINT           = "Click a row to expand. Shift+click an item to link it in chat.",
        MINIMAP_TIP1   = "|cff33ff99CraftCheck|r",
